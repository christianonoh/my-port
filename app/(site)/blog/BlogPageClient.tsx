      ...
      <main className="max-w-7xl mx-auto md:px-16 px-6 lg:px-20 py-8 md:py-16">
        ...
        {initialFeaturedPosts && initialFeaturedPosts.length > 0 && (
          <section className="mb-12 md:mb-16">
            ...
            <StaggerContainer className="grid md:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8">
        ...
        <section>
          ...
          {initialBlogPosts && initialBlogPosts.length > 0 ? (
            <StaggerContainer className="space-y-6 md:space-y-0 grid md:grid-cols-2 md:gap-8">
            ...
            <div className="text-center py-12 md:py-16">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  I&apos;m working on some great content. Check back soon for
                  new articles!
                </p>
              </div>
            </div>
