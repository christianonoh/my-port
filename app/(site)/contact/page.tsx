      ...
      <main className="max-w-7xl mx-auto md:px-16 px-6 lg:px-20 py-16 min-h-screen">
        <ScrollReveal>
          <div className="mb-12">
            ...
            <div className="flex items-center gap-2 mt-4 text-sm text-gray-dark dark:text-gray">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <ScrollReveal direction="right" className="lg:order-1">
            <div className="space-y-8 p-6 bg-white/30 dark:bg-gray-900/30 rounded-xl border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm">
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                  ...
                  discuss ideas, or just want to connect, I&apos;d be happy to
                  hear from you.
                </p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="ml-auto">
                          <svg
                            className="w-5 h-5 text-gray-400 dark:text-gray-400 group-hover:text-accent transition-colors duration-300"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
              ...
              <div className="p-6 bg-gradient-to-r from-accent/10 to-accent-dark/10 dark:from-accent/15 dark:to-accent-dark/15 rounded-lg border border-accent/20 dark:border-accent/30 backdrop-blur-sm">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                  ...
                  matters, feel free to reach out on LinkedIn for faster
                  communication.
                </p>
              </div>
            </div>
