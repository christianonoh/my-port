      ...
      <main className="max-w-7xl mx-auto md:px-16 px-6 lg:px-20 py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:order-1 space-y-8">
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="flex items-center gap-4 p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 hover:shadow-lg dark:hover:shadow-gray-800/20 transition-all duration-300 group"
                    >
            ...
            <div className="p-6 bg-gradient-to-r from-accent/10 to-accent-dark/10 dark:from-accent/20 dark:to-accent-dark/20 rounded-lg border border-accent/20">
