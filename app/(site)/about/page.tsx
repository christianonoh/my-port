          ...
          profile.map((data) => (
            <div key={data._id}>
              <section className="grid lg:grid-cols-2 grid-cols-1 gap-x-6 justify-center justify-items-center">
                <ScrollReveal className="order-2 col-span-1 lg:order-none">
                ...
                <div className="lg:order-1 col-span-1 order-none mb-12 flex flex-col justify-start items-center">
                  <ScrollReveal direction="right" className="lg:sticky top-0 flex flex-col justify-self-center gap-y-8 transition-all ease-in-out duration-200">
                    <>
                      <Image
                        ...
                        className="rounded-2xl mb-4 object-cover object-top border-2 border-accent/10 max-h-96 min-h-96 bg-top"
                      />
                      <div className="flex gap-4 w-full">
                        <a
                          ...
                          href={`${data.resumeURL}`}
                          target="_blank"
                          className="flex flex-1 items-center justify-center gap-x-2 dark:hover:border-accent/50 dark:bg-dark hover:border-accent/50 bg-light border border-transparent
                       rounded-md duration-200 py-2 text-center cursor-pointer font-medium text-sm sm:text-lg shadow-sm dark:shadow-light/10"
                        ...
                        dark:hover:border-accent/50 shadow-sm dark:shadow-light/10 hover:border-accent/50 bg-light rounded-md duration-200 py-2 px-4 hover:bg-accent hover:text-light cursor-pointer font-medium text-sm sm:text-lg"
                        >
