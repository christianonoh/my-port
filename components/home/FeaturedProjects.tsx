    ...
    <section className="relative py-24 lg:py-32">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 mb-16 lg:mb-24">
        <div className="max-w-2xl mb-8">
          <h2 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold uppercase dark:text-light text-dark mb-6 leading-[1.05] tracking-tight font-outfit">
            Featured Projects
          </h2>
          <p className="text-base md:text-lg text-[#888] leading-relaxed">
            These projects showcase my expertise in solving business challenges
            through data — combining strategic analytics with award-winning
