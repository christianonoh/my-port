...
const ContactMe = () => {
  return (
    <div className="fixed right-4 bottom-4 flex justify-center items-center overflow-hidden z-20">
      <div className="sm:w-32 w-24 h-auto flex items-center justify-center relative group">
